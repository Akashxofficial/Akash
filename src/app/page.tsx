      ...
      bg-no-repeat relative" style={{ backgroundColor: '#ffeae5' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-6xl mx-auto overflow-hidden">
            ...
            <div 
              className="absolute inset-1 rounded-[80px] -z-10"
              style={{
              ...
              <div className="flex flex-col lg:flex-row items-center gap-8 relative overflow-hidden lg:overflow-visible">
                ...
                */}
                ...
                >
                  ...
                  >
                    <h3 
                      className="text-xl lg:text-2xl font-bold mb-2 text-center break-words" 
                      style={{ 
                        color: '#d4ff00', 
                        wordWrap: 'break-word', 
                    ...
                    <p 
                      className="text-white text-xs lg:text-sm leading-relaxed flex-1 break-words overflow-hidden text-center" 
                      style={{ 
                        wordWrap: 'break-word', 
                        overflowWrap: 'break-word', 
                        hyphens: 'auto', 
